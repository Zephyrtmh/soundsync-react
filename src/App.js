...
function App() {
  ...
  //   let response = await axios.get(process.env.REACT_APP_BASE_URL + "/login");
  //   window.location.href = response.data.authorizationUrl;
  //   console.log("code_verifier in authorization", response.data.codeVerifier);

  //   localStorage.setItem("code_verifier", response.data.codeVerifier);
  // }
